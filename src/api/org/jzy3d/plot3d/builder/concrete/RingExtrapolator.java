...
public class RingExtrapolator extends OrthonormalTesselator{
	public RingExtrapolator(float ringMax, ColorMapper cmap, Color factor){
		this.ringMax      = ringMax;
		this.cmap         = cmap;
		this.factor       = factor;
		this.interpolator = new RingInterpolator(0, ringMax, cmap, factor);
	}
	...
	public List<Polygon> getExtrapolatedRingPolygons(){
		...
		interpolator.y = y;
		interpolator.z = z;
		List<Polygon> polygons = interpolator.getInterpolatedRingPolygons();
	...
	protected RingInterpolator interpolator;
}

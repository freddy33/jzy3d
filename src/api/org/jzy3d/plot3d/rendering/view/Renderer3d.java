...
public class Renderer3d implements GLEventListener{
	...
	public void init(GLAutoDrawable canvas){
		...
		if(canvas!=null && canvas.getGL()!=null && canvas.getGL().getGL2()!=null){
			...
			if(debugGL) canvas.getGL().getContext().setGL( GLPipelineFactory.create("javax.media.opengl.Debug", null, canvas.getGL(), null) );
	        if(traceGL) canvas.getGL().getContext().setGL( GLPipelineFactory.create("javax.media.opengl.Trace", null, canvas.getGL(), new Object[] { System.err } ) );
		}
	}
	/** 
	...
	public void display(GLAutoDrawable canvas){
		...
		// gl render
		if(view!=null)
			view.render(gl, glu); // seems that actual GL2 orders are executed latter

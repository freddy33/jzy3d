 ...
 * Canvas interface.
 * <p>
 * This interface defines the set of methods that any concrete canvas
 * should define.
 * 
 * Concrete canvases should be defined in order to provide a way to draw
 * a wafer representation on various window toolkig (AWT, SWT, etc).
 * 
